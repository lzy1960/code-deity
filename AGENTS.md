...
- 目标： 在**当前实现**中，将算力推进到 `1e120 CP`，并将“奇点筹备度”提升到 `100`，达成第一次“技术奇点”重置。
- 远期设计备注： `1e308 CP` 仍可作为更长期的大版本目标，但不代表当前可玩版本门槛。
...
- 目标： 达成“技术奇点”，进入“编程范式”技能树循环，并继续积累“奇点算力 (SP)”。
- 核心体验： 引入质变的、颠覆性的新系统，策略选择变得至关重要。
- 创世纪重置 I：技术奇点 (Singularity)
  - 解锁： 在**当前实现**中，需要 `CP >= 1e120` 且“有效奇点筹备度 >= 100”。
